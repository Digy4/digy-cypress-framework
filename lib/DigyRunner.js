...
let DigyRunner = {
  ...
  _getResult: (result) => { // need to change this
    let resultType;
    let resultMessage;
    if (result.passed){
      resultType = 'PASS';
      resultMessage = 'Executed Successfully';
      DigyRunner.testResultSummary.passedCount++;
    }
    else {
      resultType = 'FAIL';
      resultMessage = result.error;
      DigyRunner.testResultSummary.failedCount++;
    }
  ...
  */
  ...
  sendResult: async (env, results) => {
    // temporary, will need to call _getResult at some point
